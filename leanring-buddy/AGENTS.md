...
- Keep screen-aware primary narrative copy in `CompanionPanelPrimaryContentCard` and tutorial-specific secondary cards in `CompanionPanelTutorialCards`; `CompanionPanelView` should compose those modules and own only panel state/actions.
