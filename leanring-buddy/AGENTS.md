...
- Keep reusable cursor overlay indicators in `OverlayIndicators` and AV/WebKit player bridges in `OverlayVideoPlayers`; `OverlayWindow` should focus on window lifecycle and the main cursor overlay composition.
