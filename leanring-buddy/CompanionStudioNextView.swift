...
private struct CompanionStudioCompanionScene: View {
    ...
    private var computerUseStatusBlock: some View {
        VStack(alignment: .leading, spacing: 12) {
            ...
            HStack(spacing: 10) {
                computerUseModeButton(
                    title: "Off",
                    isSelected: computerUsePermissionMode == .off
                ) {
                ...
                computerUseModeButton(
                    title: "Observe",
                    isSelected: computerUsePermissionMode == .observeOnly
                ) {
                ...
                computerUseModeButton(
                    title: "Review",
                    isSelected: computerUsePermissionMode == .review
                ) {
                ...
                computerUseModeButton(
                    title: "Direct",
                    isSelected: computerUsePermissionMode == .direct
                ) {
