...
- **Overlay Structure**: Keep reusable cursor overlay indicators in `OverlayIndicators`, AV/WebKit player bridges in `OverlayVideoPlayers`, SwiftUI cursor composition in `BlueCursorView`, and AppKit window lifecycle in `OverlayWindowManager`.
