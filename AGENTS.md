...
- **Studio Scene Structure**: Keep Studio tab content in dedicated scene files where practical, and compose shared cards, rows, and shell elements from `CompanionStudioChrome` instead of duplicating local styling inside the root Studio view.
