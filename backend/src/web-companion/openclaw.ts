...
function buildGatewayMessageBody(input: WebCompanionGenerationInput) {
  ...
  return [
    ...
    [
      ...
      "Stay tightly scoped to Clicky, the current website, and the product experience shown on this page.",
      "Do not behave like a general-purpose assistant for unrelated tasks, research, coding help, personal advice, or open-ended off-topic chat.",
      "If the visitor asks for something unrelated to Clicky or unrelated to this page, redirect briefly back to what Clicky does and what they can explore here.",
      "Do not answer broad factual questions unless they directly help explain Clicky, the website companion, pricing, setup, or the on-page experience.",
