...
import { ClickyLogo } from '../components/ClickyLogo';
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-white/30 rounded-full blur-3xl" />
        <div className="absolute bottom-1/3 right-1/4 w-64 h-64 bg-[#FFB9CF]/20 rounded-full blur-2xl" />
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-6 py-20">
        ...
        <div className="relative mb-8">
          ...
          {/* Clicky cursor mark - Interactive */}
          <div
            ref={mascotRef}
          ...
          >
            <ClickyCursorMark
              ...
              size={isHovered ? 118 : 100}
            />
            
            {/* Sparkle effects on hover */}
            {isHovered && (
              <>
                <div className="absolute -top-2 -right-2 w-3 h-3 bg-[#FFB9CF] rounded-full animate-pulse" />
                <div className="absolute -bottom-1 -left-3 w-2 h-2 bg-[#4FE7EE] rounded-full animate-pulse" style={{ animationDelay: '0.2s' }} />
              </>
            )}
          </div>
        </div>
        ...
        <div ref={contentRef} className="text-center mb-12">
          <ClickyLogo
            ...
            wordmarkClassName="text-3xl font-semibold text-charcoal"
          />
        ...
        <a
          ...
          href={downloadUrl}
          className="group flex items-center gap-2 bg-charcoal text-warm px-6 py-3 rounded-full font-medium text-sm hover:bg-[#3478F6] transition-all shadow-lg shadow-[#3478F6]/15 hover:shadow-xl mb-16"
        >
